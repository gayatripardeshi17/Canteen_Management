...
beginning:
system("CLS");
cout<<"*******************************************WELCOME TO ADITI FAST FOOD*********************************************"<<endl;
cout<<"Please Enter Your Name: ";
cin.getline(name, 20);
cout<<"Hello "<<name<<"\n\nWhat would you like to order?\n\n";
cout<<"******************************************MENU CARD OF ADITI FAST FOOD*******************************************"<<endl;
cout<<"1) Pizzas\n";
cout<<"2) Burgers\n";
cout<<"3) Sandwich\n";
cout<<"4) Rolls\n";
...
cout<<"\n\nThank you For Ordering From ADITI FAST FOOD"<<endl;
break;
case 2:
cout<<"**********Your Order**********"<<endl;
...
cout<<""<<quantity<<" "<<bur2;
cout<<"\nYour Total Bill is"<<choice<<"\nYour Order Will be delivered in 40 Minutes";
cout<<"\nThank you For Ordering From ADITIFAST FOOD"<<endl;
break;
case 3:
cout<<"**********Your Order**********"<<endl;;
cout<<""<<quantity<<" "<<bur3;
